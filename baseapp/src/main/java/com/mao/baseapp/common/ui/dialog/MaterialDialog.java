...
import com.mao.baseapp.common.utils.ScreenUtils;
...
public class MaterialDialog {
    ...
    private class Builder {
        ...
        private Builder() {
           ...
           // new  ViewGroup.LayoutParams(ScreenUtils.getScreenWidth(mContext) -dip2px(10), ViewGroup.LayoutParams.WRAP_CONTENT)
            WindowManager.LayoutParams  lp = mAlertDialog.getWindow().getAttributes();
            lp.width = ScreenUtils.getScreenWidth(mContext) ;//定义宽度
            mAlertDialog.getWindow().setAttributes(lp);
            mAlertDialogWindow = mAlertDialog.getWindow();
            View contentView = LayoutInflater.from(mContext)
                                             .inflate(
                                                     R.layout.material_dialog,
                                                     null);
