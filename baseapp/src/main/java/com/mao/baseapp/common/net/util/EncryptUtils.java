 ...
 * 加密常用类
 */
@SuppressLint("NewApi") public class EncryptUtils {
	// 密钥是16位长度的byte[]进行Base64转换后得到的字符串
	public static String key = "MiboStGtOpF4xNyvYt54EQ==";
...
//		Base64 decoder = new Base64();
		byte[] encBuf = Base64.decode(xmlStr, Base64.DEFAULT);
	...
	public static void getKeyIV(String encryptKey, byte[] key, byte[] iv) {
		// 密钥Base64解密
		byte[] buf = Base64.decode(encryptKey, Base64.DEFAULT);
		// 前8位为key
		int i;
	...
	/*public static void main(String[] args) throws Exception {
		//System.out.println(encrypt("http://localhost:8080/mibo/m/live/save?userId=38&liveName=aaacatId=1&imageUrl=157"));
		System.out.println(decrypt(encrypt("http://localhost:8080/mibo/m/live/save?userId=38&liveName=aaacatId=1&imageUrl=157")));
	}*/
}
